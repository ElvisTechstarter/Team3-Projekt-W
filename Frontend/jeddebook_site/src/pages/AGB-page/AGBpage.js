...
import styles from './AGBPage.module.css'; // Importiere CSS-Module

function AGBPage() {
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Allgemeine Geschäftsbedingungen</h1>
      <h2 className={styles.section}>1. Geltungsbereich</h2>
      <p className={styles.paragraph}>
        Für alle Lieferungen von DemoShop e.K. (nachfolgend DemoShop) an Verbraucher gelten diese Allgemeinen Geschäftsbedingungen (AGB).
        Verbraucher ist jede natürliche Person, die ein Rechtsgeschäft zu einem Zwecke abschließt, der überwiegend weder ihrer gewerblichen noch ihrer selbstständigen beruflichen Tätigkeit zugerechnet werden kann.
      </p>

      <h2 className={styles.section}>2. Vertragspartner</h2>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.section}>3. Vertragsschluss</h2>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.section}>4. Widerrufsrecht</h2>
      <p className={styles.paragraph}>
      ...
      <h3 className={styles.section}>Widerrufsbelehrung</h3>
      <p className={styles.paragraph}>
      ...
      <p className={styles.paragraph}>
        Sie haben die Waren unverzüglich und in jedem Fall spätestens binnen vierzehn Tagen ab dem Tag, an dem Sie uns über den Widerruf dieses Vertrags unterrichten, an uns oder an (hier sind gegebenenfalls der Name und die Anschrift der von Ihnen zur Entgegennahme der Ware ermächtigten Person einzufügen) zurückzusenden oder zu übergeben. Die Frist ist gewahrt, wenn Sie die Waren vor Ablauf der Frist von vierzehn Tagen absenden.
      </p>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.section}>5. Preise und Versandkosten</h2>
      <p className={styles.paragraph}>
        Die auf den Produktseiten genannten Preise enthalten die gesetzliche Mehrwertsteuer und sonstige Preisbestandteile.
      </p>
      <p className={styles.paragraph}>
        Zusätzlich zu den angegebenen Preisen berechnen wir für die Lieferung innerhalb Deutschlands pauschal 5,- Euro pro Bestellung. Die Versandkosten werden Ihnen auf den Produktseiten, im Warenkorbsystem und auf der Bestellseite nochmals deutlich mitgeteilt.
      </p>
      <p className={styles.paragraph}>
        Bei Zahlung per Nachnahme wird zusätzlich eine Gebühr in Höhe von 5,- Euro fällig, die der Zusteller vor Ort erhebt. Weitere Steuern oder Kosten fallen nicht an.
      </p>

      <h2 className={styles.section}>6. Lieferung</h2>
      <p className={styles.paragraph}>
      ...
      <h2 className={styles.section}>7. Zahlung</h2>
      <p className={styles.paragraph}>
